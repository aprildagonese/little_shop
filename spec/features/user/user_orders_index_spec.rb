...
RSpec.describe 'as a user', type: :feature do
  ...
  before :each do
    ...
    @order_item_1 = create(:order_item, item: @item_1, order: @order_1, sale_price: 2, quantity: 5)
    @order_item_2 = create(:order_item, item: @item_2, order: @order_1, sale_price: 2, quantity: 5)
    @order_item_3 = create(:order_item, item: @item_3, order: @order_1, sale_price: 2, quantity: 5)

    @order_item_4 = create(:order_item, item: @item_4, order: @order_2, sale_price: 2, quantity: 5)
    @order_item_5 = create(:order_item, item: @item_5, order: @order_2, sale_price: 2, quantity: 5)
    @order_item_6 = create(:order_item, item: @item_6, order: @order_2, sale_price: 2, quantity: 5)

    @order_item_7 = create(:order_item, item: @item_7, order: @order_3, sale_price: 2, quantity: 5)
    @order_item_8 = create(:order_item, item: @item_8, order: @order_3, sale_price: 2, quantity: 5)
    @order_item_9 = create(:order_item, item: @item_9, order: @order_3, sale_price: 2, quantity: 5)

    @order_item_10 = create(:order_item, item: @item_10, order: @order_4, sale_price: 2, quantity: 5)
  ...
  context 'when visiting profile orders' do
    ...
    it 'sees a list of all orders' do
      ...
      within "#order-#{@order_2.id}" do
        ...
        expect(page).to have_content("Order Total: $#{@order_2.total_cost}.00")
      end
      ...
      within "#order-#{@order_3.id}" do
        ...
        expect(page).to have_content("Order Total: $#{@order_3.total_cost}.00")
      end
      ...
      within "#order-#{@order_4.id}" do
        ...
        expect(page).to have_content("Order Total: $#{@order_4.total_cost}.00")
      end
