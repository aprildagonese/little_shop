...
RSpec.describe "as a merchant" do
  ...
  context "if the final item has been fulfilled" do
    it "the order status changes" do
      ...
      @i2, @i4 = create_list(:item, 2, user: @merchant_2, quantity: 10)
      @oi1, @oi2, @oi3, @oi4, @oi5 = create_list(:order_item, 5)
      ...
      @oi4.update(order: @order2, item: @i4, sale_price: 5, quantity: 6, fulfillment_status: 1)
      @oi5.update(order: @order2, item: @i5, sale_price: 6, quantity: 6)
      @order_items = [@oi1, @oi2, @oi3, @oi4, @oi5]
