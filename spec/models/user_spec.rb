    ...
    context 'merchant dash stats' do
      ...
      describe '#yearly_revenue' do
        it 'returns revenue by month for the last 12 months' do
          ...
          create(:order_item, item: item_1, order: user_1_order_1, created_at: 1.year.ago, updated_at: 1.year.ago)
          create(:order_item, item: item_2, order: user_1_order_2, created_at: 11.months.ago, updated_at: 11.months.ago)
          create(:order_item, item: item_3, order: user_1_order_3, created_at: 10.months.ago, updated_at: 10.months.ago)
          ...
          create(:order_item, item: item_4, order: user_2_order_1, created_at: 9.months.ago, updated_at: 9.months.ago)
          create(:order_item, item: item_1, order: user_2_order_2, created_at: 8.months.ago, updated_at: 8.months.ago)
          create(:order_item, item: item_2, order: user_2_order_3, created_at: 7.months.ago, updated_at: 7.months.ago)
          ...
          create(:order_item, item: item_3, order: user_3_order_1, created_at: 6.months.ago, updated_at: 6.months.ago)
          create(:order_item, item: item_4, order: user_3_order_2, created_at: 5.months.ago, updated_at: 5.months.ago)
          create(:order_item, item: item_1, order: user_3_order_3, created_at: 4.months.ago, updated_at: 4.months.ago)
          ...
          create(:order_item, item: item_2, order: user_4_order_1, created_at: 3.months.ago, updated_at: 3.months.ago)
          create(:order_item, item: item_3, order: user_4_order_2, created_at: 2.months.ago, updated_at: 2.months.ago)
          create(:order_item, item: item_4, order: user_4_order_3, created_at: 1.month.ago, updated_at: 1.month.ago)
